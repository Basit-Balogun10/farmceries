    ...
    return (
        <BlurView intensity={70} style={styles.container} tint="light">
                    ...
                    >
                        ...
                        >
                            {vendors.map((vendor, index) => (
                                <TouchableOpacity
                                    onPress={() =>
                                        handleFilter({ market: vendor.name })
                                    }
                                    key={index}
                                >
                                    <Image
            ...
            <View style={styles.card}>
                ...
                {openCard == 2 && (
                    <Text style={styles.cardHeader}>What's your budget?</Text>
                )}
                    ...
                    <Animated.View style={styles.cardBody}>
                        ...
                        <View className="flex flex-row items-center justify-center">
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    handleFilter({ price: JSON.stringify({min: priceFilters[0].value, max: priceFilters[1].value}) })
                                }
                            >
